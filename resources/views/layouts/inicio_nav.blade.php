            ...
            <div class="container-fluid ">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="Carta" class="nav-item nav-link inicioS_letras">Carta</a>
                        <a href="Ubi" class="nav-item nav-link inicioS_letras">Ubicación y contacto</a>
                    </div>
                    <div class="navbar-nav ms-auto">
                        <a href="ReservaComida" class="nav-item5 nav-link inicioS_letras5">RESERVAR</a>
                    </div>
                </div>
            </div>
        </nav>
