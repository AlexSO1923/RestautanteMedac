...
<body class="cuerpodefinitivo">
    <header class="carta_navegador">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid ">
                <div class="carta_logo_header">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        <a href="/" class="nav-item nav-link carta_letras">Inicio</a>
                        <a href="Ubi" class="nav-item nav-link carta_letras">Ubicación y contacto</a>
                    </div>
                    <div class="navbar-nav ms-auto">
                        <a href="ReservaComida" class="nav-item5 nav-link carta_letras5">RESERVAR</a>
                        <a href="IniciarSesion" class="nav-item5 nav-link carta_letras5">Iniciar Sesion</a>
                    </div>
                </div>
            </div>
        </nav>
