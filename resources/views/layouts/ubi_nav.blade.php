...
<body class="cuerpodefinitivo">
  <header class="ubica_navegador">
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid ">
            <div class="ubica_logo_header">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav">
                    <a href="/" class="nav-item nav-link ubica_letras">Inicio</a>
                    <a href="Carta" class="nav-item nav-link ubica_letras">Carta</a>
                </div>
                <div class="navbar-nav ms-auto">
                    <a href="ReservaComida" class="nav-item5 nav-link ubica_letras5">RESERVAR</a>
                    <a href="IniciarSesion" class="nav-item5 nav-link ubica_letras5">Iniciar Sesion</a>
                </div>
            </div>
        </div>
    </nav>
