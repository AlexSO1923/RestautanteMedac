...
<body class="cuerpodefinitivo">
    <header class="inicioS_navegador">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid ">
                <div class="inicioS_logo_header">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        <a href="/" class="nav-item nav-link inicioS_letras">Inicio</a>
                        <a href="carta.html" class="nav-item nav-link inicioS_letras">Carta</a>
                        <a href="Ubicacion.html" class="nav-item nav-link inicioS_letras">Ubicación y contacto</a>
                    </div>
                    <div class="navbar-nav ms-auto">
                        <a href="reserva1comida.html" class="nav-item5 nav-link inicioS_letras5">RESERVAR</a>
                        <a href="Iniciar_Sesion.html" class="nav-item5 nav-link inicioS_letras5">Iniciar Sesión</a>
                    </div>
                </div>
            </div>
        </nav>
